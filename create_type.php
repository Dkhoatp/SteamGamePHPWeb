...
<body>
                ...
                <section>
                    <form action="#" method="post" class="create">
                        <div class="form">
                            ...
                            <input type="number" name="type_id" class="alert-dark form-control" pattern=""
                                title="Please enter a id type">
                        </div>
                        <div class="form">
                            <label for="">
                                Name Type
                            ...
                            <input type="text" name="type" class="alert-dark form-control" required max="80" step="10"
                                min="0" title="Please enter a event sales">
                        </div>
                        <input type="submit" name="submit" value="Create Type" class="btn-primary btn btn-rounded">
                    </form>
                </section>
            </div>
        </div>
    ...
    <?php
        if (isset($_POST["submit"])) {
            ...
            $type = $_POST["type"];
            $call = new product("", "", "", "", "", "", "", "", "", "");
            $call->inserttype($conn, $type_id, $type);
