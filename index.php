    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="content row">
                <div class="col-md-1"></div>
                <div class="col-md-10">
                    <div style="margin-top: 25px"><form action="" method="post">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        if ($row['status'] == "true") {
                            ...
                            if (isset($_POST['vn'])) {
                                ...
                                $return1 = $client->__soapCall("currency_format", array("$tien"));
                               
                            } else {
                                $client = new SoapClient("http://localhost:1000/server/Hello.wsdl", array('trace' => 1));
                                $return1 = $client->__soapCall("currency_usd", array("$tien"));
                            ...
                            <div class="product">
                                ...
                                <div style="height: 30%; width: 100%;background-image: linear-gradient(black, blue);">
                                    <h3><?php echo $row['name']; ?></h3>
                                    <h4 style="font-size: 15px;"><?php echo $return1?></h4>
                                </div>
                            </div>
                            <?php
                        }
        ...
        <footer class=" text-center text-white" style="background-color: #171A21;">
            ...
            <div class="container p-4 pb-0">
                ...
                <section class="mb-4">
                    ...
                    <!-- Linkedin -->
                    <a class="btn btn-primary btn-floating m-1" target="_blank" style="background-color: #0082ca;" href="http://localhost:1000/steamgame/RSS/create_rss.php"
                       role="button"><i class="fa fa-rss"></i></a>
                    <!-- Github -->
